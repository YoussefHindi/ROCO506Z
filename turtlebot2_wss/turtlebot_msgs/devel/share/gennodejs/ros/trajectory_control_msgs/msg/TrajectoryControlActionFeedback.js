...
class TrajectoryControlActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TrajectoryControlFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TrajectoryControlFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryControlActionFeedback(null);
    ...
    data.feedback = TrajectoryControlFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TrajectoryControlFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryControlActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TrajectoryControlFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TrajectoryControlFeedback()
    }
...
module.exports = TrajectoryControlActionFeedback;
